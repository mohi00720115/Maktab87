...
public class FragmentFirstBindingImpl extends FragmentFirstBinding  {
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.viewModel1 == variableId) {
            setViewModel1((com.example.mohsenakhlaghi_hw10_geoquiz.FirstViewModel) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setViewModel1(@Nullable com.example.mohsenakhlaghi_hw10_geoquiz.FirstViewModel ViewModel1) {
    ...
    protected void executeBindings() {
        ...
        com.example.mohsenakhlaghi_hw10_geoquiz.FirstViewModel viewModel1 = mViewModel1;
